  ...
  return (
    ...
    <div className="book-container">
      ...
      <button className="floating-chapter-btn" onClick={toggleChapterList}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon" class="w-6 h-6 text-neutral-700"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12"></path></svg>
        </button>
        {showSidebar && (
